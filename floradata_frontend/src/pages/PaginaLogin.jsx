    ...
    <div
      ...
      <div
        ...
        <div
          ...
          <h1 className="text-3xl font-semibold md:text-4xl" style={{ color: corTitulo }}>Bem-vindo de volta ao FloraData!</h1>
          <h3 className="text-xl  mb-4 md:mb-8" style={{ color: verdeEscuro }}>Acesse sua conta e continue cultivando!</h3>
